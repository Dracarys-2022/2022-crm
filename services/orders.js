...
import {LISTGET,LISTORDERS,REQUESTOUT,OUT,RETURNSTATE,COMPLATE,PREFIT,PREFIT1,ALLPRO} from '@/services/api'
...
async function requestout(oid) {
  ...
  //退换
  async function returnstate(oid) {
    return request(RETURNSTATE, METHOD.GET, {
        oid:oid,
        current:1,
        size:5
    })
...
export { addorders,getproduct,listorders,requestout,out,returnstate,complate,prefit,prefit1,allpro}