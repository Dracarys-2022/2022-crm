  ...
  <div>
    ...
    <a-card style="margin-top: 24px" :bordered="false" title="修改密码">
      <a-form-model ref="operator1" :model="operator1" :label-col="labelCol" :wrapper-col="wrapperCol" layout="horizontal"
        ...
        <a-form-model-item class="a" label="新密码" prop="endPassword">
          <a-input-password name="password" v-model="operator1.endPassword" placeholder="请新密码输入密码" />
...
export default {
  data() {
    ...
    const pwdAgainCheck = async (rule, value, callback) => {
      ...
      } else if (this.operator.endPassword != this.operator.againPassword) {
        this.changeAgainFlag = 2;
